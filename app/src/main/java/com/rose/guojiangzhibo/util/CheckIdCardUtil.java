...
public class CheckIdCardUtil {
	...
	public static boolean validate(String cardNumber){
		return new CheckIdCardUtil(cardNumber)._validate();
	}
	 ...
	 * @return
	 */
	private CheckIdCardUtil(String cardNumber) {
		if (null != cardNumber) {
...
//
//		System.out.println( CheckIdCardUtil.validate("12022119851014005x"));
//
//	}
}
