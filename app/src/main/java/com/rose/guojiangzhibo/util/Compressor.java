...
public class Compressor {
    ...
    private Compressor(Context context) {
        ...
        destinationDirectoryPath = context.getCacheDir().getPath() + File.pathSeparator + FileOptsUtil.FILES_PATH;
    }
    ...
    public File compressToFile(File file) {
        return ImageOptsUtil.compressImage(context, Uri.fromFile(file), maxWidth, maxHeight, compressFormat, quality, destinationDirectoryPath);
    }

    public Bitmap compressToBitmap(File file) {
        return ImageOptsUtil.getScaledBitmap(context, Uri.fromFile(file), maxWidth, maxHeight);
    }
